...
char defaultMessage[] = "GLUT significa OpenGL.";
...
display(void)
{
    ...
    output(0, 24, "Este mensaje fue escrito en la fuente bitmap de GLUT ");
    output(100, 100, message);
    output(50, 145, "(colocado en pixeles con origen arriba-izquierda)");
